...
## 🔴 CRITICAL UPDATE · 2026-08-29 · «Новый формат блока "Что вас ждёт?"»

**Виктория утвердила замену формата блока "Что вас ждёт?" на прозаический абзац.** Старая версия с восемью 🫶-буллетами больше НЕ используется.

### Новый утверждённый формат блока «Что вас ждёт?»

Один плотный абзац без буллетов и без эмодзи. Каждый элемент это отдельное предложение через точку. Первое предложение всегда одно и то же — про древние практики.

**Русский эталон (использовать дословно):**

> **Что вас ждёт?**
>
> Древние тантрические практики возвращения в тело, которые передавались из уст в уста тысячелетиями. Экстатические танцы для освобождения тела и ума. Практики раскрытия сердца для подлинной близости. Исследование расширенных состояний сознания. Блаженные моменты умиротворения и радости. Значимые встречи с единомышленниками.

**English canonical (use verbatim):**

> **What Awaits You?**
>
> Ancient tantric practices of returning to the body, passed from mouth to mouth for millennia. Ecstatic dances to free the body and mind. Heart-opening practices for genuine connection. Exploration of expanded states of consciousness. Blissful moments of serenity and joy. Meaningful connections with a like-minded community.

Этот блок теперь идёт после «На этом воркшопе мы:» одним прозаическим абзацем. Никаких 🫶 внутри. Единственный эмодзи после блока — 👉 перед ссылкой на регистрацию.
