...
superseded_by: /agents/audience_psychology_researcher.md
do_not_activate: true
reason: |
  Заменён более глубоким Skill'ом Audience Psychology Researcher,
  который включает 5 карт (Pain, Desire, Fear, Identity, Transformation),
  8 исследовательских вопросов и интеграцию с другими Skills в новой
  AI-команде.
---
...
Используй вместо него: `/agents/audience_psychology_researcher.md`

Файл сохранён для истории и справки.

---

# Audience Agent (архивная версия · апрель 2026)
