...
reason: |
  Заменён более широким и глубоким Skill'ом Content & Conversion Architect,
  который покрывает 13+ форматов контента с точными структурами каждого
  (Reels, посты, карусели, YouTube-сценарии, Stories, Telegram-посты,
  лендинги, email, реклама, офферы, заголовки, вебинары, описания продуктов),
...
Используй вместо него: `/agents/content_conversion_architect.md`

Файл сохранён для истории и справки.

---

# Content Creator Agent (архивная версия · апрель 2026)
